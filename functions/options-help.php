...
switch ( $tab ) {
       	case 'general' :
       		$tabtext = wp_distinctionpp_get_contextual_help_options_general();
       		break;
       	case 'layout' :
       		$tabtext = wp_distinctionpp_get_contextual_help_options_layout();
       		break;
		case 'style' :
       		$tabtext = wp_distinctionpp_get_contextual_help_options_style();
       		break;
}

function wp_distinctionpp_get_contextual_help_options_general() {
...
function wp_distinctionpp_get_contextual_help_options_layout() {
...
function wp_distinctionpp_get_contextual_help_options_style() {
